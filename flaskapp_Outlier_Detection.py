...
if balanceData:
    scaled_data, y,X_train, X_test, y_train, y_test = balanced_data(filename)
else : 
    scaled_data, y,X_train, X_test, y_train, y_test = read_preprocess_data(filename)
